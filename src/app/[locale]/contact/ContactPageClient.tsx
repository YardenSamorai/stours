...
export default function ContactPageClient({
  ...
  const hoursDisplay = settings.businessHoursFriday
    ? `${settings.businessHours} | ${settings.businessHoursFriday}`
    : settings.businessHours;

  const contactInfo = [
    { icon: Phone, label: locale === 'he' ? 'טלפון' : 'Phone', value: settings.phoneDisplay, href: `tel:${phoneClean}` },
    { icon: Mail, label: locale === 'he' ? 'אימייל' : 'Email', value: settings.email, href: `mailto:${settings.email}` },
    { icon: Clock, label: locale === 'he' ? 'שעות פעילות' : 'Business Hours', value: hoursDisplay, href: null },
  ];
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white/90 text-sm mb-6">
              ...
              {locale === 'he' ? 'נשמח לשמוע מכם' : 'We\'d love to hear from you'}
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              >
                ...
                <div>
                  <div className="font-bold text-lg">{locale === 'he' ? 'שלחו הודעה בווטסאפ' : 'Send a WhatsApp message'}</div>
                  <div className="text-green-100 text-sm">{locale === 'he' ? 'מענה מהיר ואישי' : 'Fast & personal response'}</div>
                </div>
              </a>
                ...
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-slate-800">
                      {locale === 'he' ? 'תכננו את הטיול הבא' : 'Plan your next trip'}
                    </h2>
                    <p className="text-slate-500">
                      {locale === 'he' ? 'מלאו את הפרטים ונחזור אליכם בהקדם' : 'Fill in the details and we\'ll get back to you soon'}
                    </p>
                  </div>
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          placeholder={locale === 'he' ? 'הכנס את שמך' : 'Enter your name'}
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                          placeholder={locale === 'he' ? 'יוון, תאילנד, איטליה...' : 'Greece, Thailand, Italy...'}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder={locale === 'he' ? 'ספרו לנו על הטיול שאתם מחפשים...' : 'Tell us about the trip you\'re looking for...'}
                      />
                    </div>
