...
export default function EditDealPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('שגיאה בעדכון הדיל. אנא נסה שוב.');
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500">עדכן את פרטי הדיל</p>
        </div>
      </div>
...
className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 bg-slate-50"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">תאריך יציאה</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">תאריך חזרה</label>
                <input
                  type="date"
