...
export default function NewTestimonialPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('שגיאה ביצירת ההמלצה. אנא נסה שוב.');
    } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800">המלצה חדשה</h1>
          <p className="text-slate-500">הוסף המלצת לקוח חדשה</p>
        </div>
      </div>
